  ...
  return (
    <div className='py-16'>
      <div className='w-[95%] text-center mx-auto max-w-[600px]'>
        ...
        <div className='flex mx-auto mt-6 w-fit gap-3 flex-wrap'>
          <button className='mx-auto text-black py-3 px-4 font-semibold rounded-xl bg-white'>Explore Event</button>
          <button className='mx-auto text-white py-3 px-4 font-semibold rounded-xl bg-[#10BFDB]'>Create Event</button>
        </div>
      </div>
    </div>
  )
